...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Edinburgh Twins Club :: Triplets</title>
  </head>
  <body>
...
<iframe style="margin: 0 auto; border: 0; width: 120px; height: 90px;" src="http://rcm-uk.amazon.co.uk/e/cm?t=edinburghtwin-21&amp;o=2&amp;p=20&amp;l=qs1&amp;f=ifr" scrolling="no"></iframe>
    ...
    <h1 class="header">Triplets</h1>
        <p><strong>Welcome to the triplets page</strong></p> 
...
<p><i>p.s.</i> See the <a href="../events">events page</a> for details of upcoming triplets parents evenings!</p>

<div class="elastic-photo-bar">
<img src="..//graphics/photos/JOYCE02.jpg" alt="The Joyce Family"/>
</div>
