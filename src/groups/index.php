[%
    SET title = "Edinburgh Twins Club :: Groups";
    SET root = "../";
    INCLUDE 'header.inc';
    INCLUDE 'sidebar.inc';
%]
...
also check the <b><a href="[% root
%]messageboard/viewforum.php?f=5">message board</a></b> for
...
href="[% root %]events/calendar">events calendar</a></b> for dates, and the <b><a href="[%
root %]messageboard/viewforum.php?f=7">First Year's message board</a></b>
for announcements.</p>
